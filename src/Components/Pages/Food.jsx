  ...
  return (
    <div id="food" className="pt-45 md:pt-40 lg:pt-30">
      ...
      <ul className="flex flex-col gap-5 pb-10">
        ...
        <StoreCard logo={pizza} title={"Pizza Wings Delicious Food"} discription={"Delicious Food, Fresh Dough, Fresh Ingredients With the time and their unbeaten quality, Pizza Wings spread it's wings around Delhi-NCR and all over Haryana."} image1={pizza1} image2={pizza2} image3={pizza3}/>

        <StoreCard logo={heaven} title={"7th Heaven - Bakery Cafe"} discription={"7th Heaven is India's Ultimate Bakery Cafe Chain with Live Kitchen - Live Cakes in 7 Mins.* 7th Heaven serves products like 3D Cakes, Cupcakes, Macarons, Donuts, Tarts, Brownies, Cheese Cakes, Pizzas, Pasta, Burgers and much more!"} image1={pastries} image2={peoplescake} image3={tcake}/>

        <StoreCard logo={bear} title={"Sip the Refreshment"} discription={"From nature to your hands, our beverage delivers unmatched freshness, delightful flavor, and a revitalizing experience that quenches thirst and lifts your spirit – anytime, anywhere, for everyone."} image1={bear1} image2={bear2} image3={bear3}/>
        </ul>
    </div>
  )
}
