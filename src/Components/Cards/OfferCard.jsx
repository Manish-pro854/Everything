...
const OfferCard = ({ name, title, discription, link, image }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[60%_40%] lg:grid-cols-[70%_30%] border mx-5 md:mx-10 lg:mx-20">
      <div className="flex flex-col items-start justify-center md:ml-5 lg:mx-10 px-5 py-7 md:p-0 md:py-0">
        ...
        <h2 className="flex items-center justify-center pt-3 text-xl pb-2">
          {link}
          <FaAngleRight className="text-xl pt-1" />
        </h2>
      </div>
